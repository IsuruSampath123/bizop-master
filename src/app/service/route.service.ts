...
export class RouteService {
  routeTypeList: Route[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/route/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/route/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/route/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/route/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/route/getMax';
    ...
    saveData(data: Route): Observable<WebServResponce> {
    ...
    editData(data: Route): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
