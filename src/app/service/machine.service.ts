...
export class MachineService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/machine/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/machine/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/machine/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/machine/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/machine/getMax';
    ...
    saveData(data: Machine): Observable<WebServResponce> {
    ...
    editData(data: Machine): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
