...
@Injectable()
export class InvoiceItemsSaveservice {

    ItemMasterList: InvoiceItemsSave[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/sales_and_debtors/invoice_free_issue_items/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/sales_and_debtors/invoice_free_issue_items/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/sales_and_debtors/invoice_free_issue_items/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/sales_and_debtors/invoice_free_issue_items/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/sales_and_debtors/invoice_free_issue_items/changeStatus';
    ...
    savedata(data: InvoiceItemsSave): Observable<WebServResponce>  {
    ...
    editdata(data: InvoiceItemsSave): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
