...
@Injectable()
export class RegisterCollectionRepservice {

    registerRepList: CollectionRepRegister[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerCollectionRep/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/registerCollectionRep/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerCollectionRep/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerCollectionRep/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerCollectionRep/changeStatus';
    private allreadyExistUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerCollectionRep/allreadyExist';
    ...
    savedata(data: CollectionRepRegister): Observable<WebServResponce>  {
    ...
    allreadyexist(data: CollectionRepRegister): Observable<WebServResponce>  {
        let body = JSON.stringify(data);
        console.log("metana tama stringfy"+JSON.stringify(data));
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
    ...
    editdata(data: CollectionRepRegister): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
