...
export class Branchservice {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/branch/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/branch/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/branch/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/branch/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/branch/changeStatus';
    ...
    savedata(data: Branch): Observable<WebServResponce>  {
    ...
    editdata(data: Branch): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
