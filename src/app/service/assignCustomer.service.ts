...
export class AssignCustomerservice {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/assignCustomer/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/assignCustomer/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/assignCustomer/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/assignCustomer/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/assignCustomer/changeStatus';
    ...
    savedata(data: AssignCustomer): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        console.log("metana tama tena "+JSON.stringify(data));
    ...
    editdata(data: AssignCustomer): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
