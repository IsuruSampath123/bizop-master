...
@Injectable()
export class SupplierTaxService {
   supplierTaxList: SupplierTax[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierTax/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierTax/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierTax/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierTax/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierTax/getMax';
    ...
    saveData(data: SupplierTax): Observable<WebServResponce> {
    ...
    editData(data: SupplierTax): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
