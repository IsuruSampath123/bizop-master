...
export class DistributionPointservice {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/distributionPoint/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/distributionPoint/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/distributionPoint/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/distributionPoint/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/distributionPoint/changeStatus';
    ...
    savedata(data: DistributionPoint): Observable<WebServResponce>  {
    ...
    editdata(data: DistributionPoint): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
