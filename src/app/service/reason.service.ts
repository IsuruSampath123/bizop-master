...
export class ReasonService {
   reasonList: Reason[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/reason/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/reason/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/reason/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/reason/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/reason/getMax';
    ...
    saveData(data: Reason): Observable<WebServResponce> {
    ...
    editData(data: Reason): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
