...
@Injectable()
export class SalesRepItemservice {

    SalesRepItemList: SalesRepItem[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/salesRepItem/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/salesRepItem/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/salesRepItem/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/salesRepItem/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/salesRepItem/changeStatus';
    ...
    savedata(data: SalesRepItem): Observable<WebServResponce>  {
    ...
    editdata(data: SalesRepItem): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
