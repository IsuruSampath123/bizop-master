...
export class CustomerTransactionService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/TransactionDetail/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/TransactionDetail/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/TransactionDetail/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/TransactionDetail/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/TransactionDetail/getMax';
    ...
    saveData(data: CustomerTransaction): Observable<WebServResponce> {
    ...
    editData(data: CustomerTransaction): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
