...
export class VehicleTypeService {
   vehicleTypeList: VehicleType[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicleType/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicleType/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicleType/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicleType/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicleType/getMax';
    ...
    saveData(data: VehicleType): Observable<WebServResponce> {
    ...
    editData(data: VehicleType): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
