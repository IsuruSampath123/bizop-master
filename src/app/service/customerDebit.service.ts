...
export class CustomerDebitService {
   customerDebitList: CustomerDebit[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/debitDetail/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/debitDetail/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/debitDetail/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/debitDetail/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/debitDetail/getMax';
    ...
    saveData(data: CustomerDebit): Observable<WebServResponce> {
    ...
    editData(data: CustomerDebit): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
