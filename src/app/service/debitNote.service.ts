...
export class DebitNoteService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/transaction/debitNote/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/transaction/debitNote/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/transaction/debitNote/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/transaction/debitNote/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/transaction/debitNote/getMax';
    ...
    saveData(data: DebitNote): Observable<WebServResponce> {
    ...
    editData(data: DebitNote): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        console.log(body);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
