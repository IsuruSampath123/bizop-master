...
export class SupplierService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplier/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplier/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplier/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplier/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplier/getMax';
    ...
    saveData(data: Supplier): Observable<WebServResponce> {
    ...
    editData(data: Supplier): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
