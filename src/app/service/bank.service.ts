...
export class BankService {
   bankList: Bank[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/bank/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/bank/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/bank/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/bank/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/bank/getMax';
    ...
    saveData(data: Bank): Observable<WebServResponce> {
    ...
    editData(data: Bank): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
