...
export class TaxTypeService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/taxType/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/taxType/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/taxType/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/taxType/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/taxType/getMax';
    ...
    saveData(data: TaxType): Observable<WebServResponce>  {
    ...
    editData(data: TaxType): Observable<WebServResponce>  {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
