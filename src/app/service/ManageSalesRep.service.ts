...
@Injectable()
export class ManageSaleRepservice {

    ManageSaleRepList: ManageSaleRep[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/manageSaleRepManager/getAll';
    private getmax = 'http://52.187.40.143:8080/erp.ws/setup/manageSaleRepManager/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/manageSaleRepManager/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/manageSaleRepManager/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/manageSaleRepManager/changeStatus';
    ...
    savedata(data: ManageSaleRep): Observable<WebServResponce> {
    ...
    editdata(data: ManageSaleRep): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
