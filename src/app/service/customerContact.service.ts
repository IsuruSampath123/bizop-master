...
export class CustomerContactService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/ContactDetail/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/ContactDetail/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/ContactDetail/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/ContactDetail/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/ContactDetail/getMax';
    ...
    saveData(data:  CustomerContact): Observable<WebServResponce> {
    ...
    editData(data:  CustomerContact): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
