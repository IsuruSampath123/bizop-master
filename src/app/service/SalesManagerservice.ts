...
export class SalesManagerservice {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/salesManager/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/salesManager/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/salesManager/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/salesManager/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/salesManager/changeStatus';
    ...
    savedata(data: SalesManager): Observable<WebServResponce>  {
    ...
    editdata(data: SalesManager): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
