...
export class ChequeReturnService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/transaction/chequeReturn/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/transaction/chequeReturn/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/transaction/chequeReturn/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/transaction/chequeReturn/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/transaction/chequeReturn/getMax';
    ...
    saveData(data:  ChequeReturn): Observable<WebServResponce> {
    ...
    editData(data:  ChequeReturn): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
