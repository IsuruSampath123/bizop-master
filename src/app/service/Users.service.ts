...
export class UsersService {
   areaList: Users[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/maintaince/users/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/maintaince/users/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/maintaince/users/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/maintaince/users/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/maintaince/users/getMax';
    ...
    saveData(data: Users): Observable<WebServResponce> {
    ...
    editData(data: Users): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
