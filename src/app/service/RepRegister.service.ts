...
@Injectable()
export class RegisterRepservice {

    registerRepList: RegisterRep[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerRep/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/registerRep/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerRep/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerRep/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerRep/changeStatus';
    private allreadyExistUrl = 'http://52.187.40.143:8080/erp.ws/setup/registerRep/allreadyExist';
    ...
    savedata(data: RegisterRep): Observable<WebServResponce>  {
    ...
    allreadyexist(data: RegisterRep): Observable<WebServResponce>  {
        let body = JSON.stringify(data);
        console.log("metana tama stringfy"+JSON.stringify(data));
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
    ...
    editdata(data: RegisterRep): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
