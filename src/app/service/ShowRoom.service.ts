...
export class ShowRoomservice {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/showRoom/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/showRoom/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/showRoom/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/showRoom/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/showRoom/changeStatus';
    ...
    savedata(data: ShowRoom): Observable<WebServResponce>  {
    ...
    editdata(data: ShowRoom): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
