...
export class CustomerLocationService {
    customerLocationList: CustomerLocation[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/locationDetail/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/locationDetail/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/locationDetail/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/locationDetail/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/locationDetail/getMax';
    ...
    saveData(data: CustomerLocation): Observable<WebServResponce> {
    ...
    editData(data: CustomerLocation): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
