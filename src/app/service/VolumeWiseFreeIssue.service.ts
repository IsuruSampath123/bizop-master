...
@Injectable()
export class VolumeWiseFreeIssueservice {

    CatagoryWiseFreeIssueList: VolumeWiseFreeIssue[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/volumeWiseFreeIssue/getAll';
    private getmax = 'http://52.187.40.143:8080/erp.ws/setup/volumeWiseFreeIssue/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/volumeWiseFreeIssue/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/volumeWiseFreeIssue/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/volumeWiseFreeIssue/changeStatus';
    private allreadyExistUrl = 'http://52.187.40.143:8080/erp.ws/setup/volumeWiseFreeIssue/allreadyExist';
    ...
    savedata(data: VolumeWiseFreeIssue): Observable<WebServResponce> {
    ...
    allreadyexist(data: VolumeWiseFreeIssue): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        console.log("metana tama stringfy" + JSON.stringify(data));
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
    ...
    editdata(data: VolumeWiseFreeIssue): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
