...
export class CityService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/city/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/city/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/city/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/city/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/city/getMax';
    ...
    saveData(data: City): Observable<WebServResponce> {
    ...
    editData(data: City): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
