...
export class OrderTypeService {
   areaList: OrderType[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/orderType/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/orderType/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/orderType/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/orderType/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/orderType/getMax';
    ...
    saveData(data: OrderType): Observable<WebServResponce> {
    ...
    editData(data: OrderType): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
