...
@Injectable()
export class MainCatagoryservice {

   maincatagoryList: MainCatagory[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/mainCatagory/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/mainCatagory/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/mainCatagory/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/mainCatagory/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/mainCatagory/changeStatus';
    ...
    savedata(data: MainCatagory): Observable<WebServResponce>  {
    ...
    editdata(data: MainCatagory): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
