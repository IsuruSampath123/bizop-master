...
export class VehicleService {
   vehicleList: Vehicle[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicle/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicle/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicle/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicle/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/vehicle/getMax';
    ...
    saveData(data: Vehicle): Observable<WebServResponce> {
    ...
    editData(data: Vehicle): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
