...
@Injectable()
export class CatagoryWiseFreeIssueservice {

    CatagoryWiseFreeIssueList: CatagoryWiseFreeIssue[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/catagoryWiseFreeIssue/getAll';
    private getmax = 'http://52.187.40.143:8080/erp.ws/setup/catagoryWiseFreeIssue/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/catagoryWiseFreeIssue/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/catagoryWiseFreeIssue/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/catagoryWiseFreeIssue/changeStatus';
    private allreadyExistUrl = 'http://52.187.40.143:8080/erp.ws/setup/catagoryWiseFreeIssue/allreadyExist';
    ...
    savedata(data: CatagoryWiseFreeIssue): Observable<WebServResponce> {
    ...
    allreadyexist(data: CatagoryWiseFreeIssue): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        console.log("metana tama stringfy" + JSON.stringify(data));
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
    ...
    editdata(data: CatagoryWiseFreeIssue): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
