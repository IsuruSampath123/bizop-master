...
export class Storeservice {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/store/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/store/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/store/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/store/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/store/changeStatus';
    ...
    savedata(data: Store): Observable<WebServResponce>  {
    ...
    editdata(data: Store): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
