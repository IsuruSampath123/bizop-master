...
@Injectable()
export class WholesaleItemService {
    wholesaleItemList:WholesaleItem[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesaleItem/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesaleItem/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesaleItem/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesaleItem/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesaleItem/getMax';
    ...
    saveData(data: WholesaleItem): Observable<WebServResponce> {
    ...
    editData(data: WholesaleItem): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
