...
@Injectable()
export class WholesalePriceService {
    wholesalePriceList:WholesalePrice[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesalePrice/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesalePrice/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesalePrice/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesalePrice/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/wholesalePrice/getMax';
    ...
    saveData(data: WholesalePrice): Observable<WebServResponce> {
    ...
    editData(data: WholesalePrice): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
