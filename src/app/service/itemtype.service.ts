...
export class ItemTypeservice {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemType/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/itemType/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemType/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemType/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemType/changeStatus';
    private allreadyExistUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemType/allreadyExist';
    ...
    savedata(data: ItemType): Observable<WebServResponce>  {
    ...
    allreadyexist(data: ItemType): Observable<WebServResponce>  {
        let body = JSON.stringify(data);
        console.log("metana tama stringfy"+JSON.stringify(data));
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
    ...
    editdata(data: ItemType): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
