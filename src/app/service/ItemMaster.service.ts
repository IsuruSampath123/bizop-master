...
export class ItemMasterservice {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemMaster/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/itemMaster/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemMaster/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemMaster/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemMaster/changeStatus';
    ...
    savedata(data: ItemMaster): Observable<WebServResponce>  {
    ...
    editdata(data: ItemMaster): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
