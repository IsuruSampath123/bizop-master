...
@Injectable()
export class SubSubCatagoryservice {

   subcatagoryList: SubSubCatagory[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/subSubCatagory/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/subSubCatagory/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/subSubCatagory/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/subSubCatagory/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/subSubCatagory/changeStatus';
    ...
    savedata(data: SubSubCatagory): Observable<WebServResponce>  {
    ...
    editdata(data: SubSubCatagory): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
