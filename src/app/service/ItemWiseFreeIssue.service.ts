...
@Injectable()
export class ItemWiseFreeIssueservice {

    ItemWiseFreeIssueList: ItemWiseFreeIssue[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemWiseFreeIssue/getAll';
    private getmax = 'http://52.187.40.143:8080/erp.ws/setup/itemWiseFreeIssue/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemWiseFreeIssue/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemWiseFreeIssue/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemWiseFreeIssue/changeStatus';
    private allreadyExistUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemWiseFreeIssue/allreadyExist';
    ...
    savedata(data: ItemWiseFreeIssue): Observable<WebServResponce> {
    ...
    allreadyexist(data: ItemWiseFreeIssue): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        console.log("metana tama stringfy" + JSON.stringify(data));
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
    ...
    editdata(data: ItemWiseFreeIssue): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
