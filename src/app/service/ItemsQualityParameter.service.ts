...
@Injectable()
export class ItemsQualityParameterservice {

    StoreList: ItemsQualityParameter[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemsQualityParameter/getAll';
    private getmax='http://52.187.40.143:8080/erp.ws/setup/itemsQualityParameter/getMax';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemsQualityParameter/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemsQualityParameter/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/itemsQualityParameter/changeStatus';
    ...
    savedata(data: ItemsQualityParameter): Observable<WebServResponce>  {
    ...
    editdata(data: ItemsQualityParameter): Observable<WebServResponce>  {
        let body = JSON.stringify(data);   
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
