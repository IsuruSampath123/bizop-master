...
//http://52.187.40.143:8080/
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/area/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/area/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/area/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/area/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/area/getMax';
    ...
    saveData(data: Area): Observable<WebServResponce> {
    ...
    editData(data: Area): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
