...
export class SupplierGroupService {
    supplierGroupList: SupplierGroup[];
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierGroup/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierGroup/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierGroup/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierGroup/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierGroup/getMax';
    ...
    saveData(data: SupplierGroup): Observable<WebServResponce> {
    ...
    editData(data: SupplierGroup): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
