...
export class CustomerCompanyService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/companyDetail/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/companyDetail/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/companyDetail/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/companyDetail/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/customer/companyDetail/getMax';
    ...
    saveData(data: CustomerCompany): Observable<WebServResponce> {
    ...
    editData(data: CustomerCompany): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
