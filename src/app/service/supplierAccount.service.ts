...
export class SupplierAccountService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierAccount/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierAccount/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierAccount/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierAccount/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/supplierAccount/getMax';
    ...
    saveData(data: SupplierAccount): Observable<WebServResponce> {
    ...
    editData(data: SupplierAccount): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        console.log(JSON.stringify(data));
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
