...
export class MachineTypeService {
    ...
    private getAllUrl = 'http://52.187.40.143:8080/erp.ws/setup/machineType/getAll';
    private saveUrl = 'http://52.187.40.143:8080/erp.ws/setup/machineType/save';
    private updateUrl = 'http://52.187.40.143:8080/erp.ws/setup/machineType/update';
    private deleteUrl = 'http://52.187.40.143:8080/erp.ws/setup/machineType/changeStatus';
    private getMaxUrl = 'http://52.187.40.143:8080/erp.ws/setup/machineType/getMax';
    ...
    saveData(data: MachineType): Observable<WebServResponce> {
    ...
    editData(data: MachineType): Observable<WebServResponce> {
        let body = JSON.stringify(data);
        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
